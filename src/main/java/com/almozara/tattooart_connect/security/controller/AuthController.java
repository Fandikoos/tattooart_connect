...
public class AuthController {
    ...
    @GetMapping("/{idUser}")
    public ResponseEntity<String> getUsernameByIdUser(@PathVariable Long idUser) {
        return new ResponseEntity<>(userService.findUsernameByIdUser(idUser), HttpStatus.OK);
    }
}
